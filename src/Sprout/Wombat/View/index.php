...
<div class="block api_connection_info" style="display:none;">
	<label><span>Username:</span><input type="text" name="api_username" value="" placeholder="athleticapi"></label>
	<label><span>Path:</span><input type="text" name="api_path" value="" placeholder="https://store-pijlvyhy.mybigcommerce.com/api/v2/"></label>
	<label><span>Token:</span><input type="text" name="api_token" value="" placeholder="d1ee45ad7d3a7c7c97b102eea8fd9763bb7cf9c9"></label>
</div>
